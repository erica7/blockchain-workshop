...
describe('BrewChain', () => {
  ...
  it('should be not let an invalid block on the chain', () => {
    ...
    // TODO: Create 2 blocks THEN try to add them
    myBrew.init();
    ...
    const block2Valid = myBrew.checkNewBlockIsValid(block2Retry, myBrew.getLatestBlock());
    ...
    expect(block2Valid).to.equal(true);
